...
// ── 探测审批定义列表（v3.2.0）──
// 供 setup 引导用户认领 QUAL_DEFINITION_CODE
function listApprovalDefinitions(pageSize = 50) {
  // 正确端点：/open-apis/approval/v4/approvals（不是 approval_definitions）
  return api('GET', '/open-apis/approval/v4/approvals', { page_size: pageSize }, 'user', { cwd: __dirname });
}
